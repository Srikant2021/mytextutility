...
export default function Navbar(props) {
  const changeToPink =()=>{
    document.body.style.backgroundColor = 'rgb(225 165 207';
  }
  const changeToCyan =()=>{
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            {/* <form className="d-flex" role="search">
              ...
              <button className="btn btn mx-1 custom" onClick={changeToPink} style={{backgroundColor:'rgb(225 165 207)'}} type="button">PINK</button>
